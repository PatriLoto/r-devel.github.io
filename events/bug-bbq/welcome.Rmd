...
<center>
<img src="bug_list.png" alt="Screenshot of R's Bugzilla showing an HTML table with the results of a search for open bugs, in order of the most recent change, with the newest at the top." style="margin-bottom:20px">
</center>
...
<center>
<img src="bug_report.png" alt="Screenshot of a bug report. We just see the start of the report here, with the metadata. In this case the bug was reported by Martin Maechler." style="margin-bottom:20px">
</center>
...
<center>
<img src="bug_report_comments.png" alt="Screenshot of a bug report comments. The first comment is the bug report itself, from Martin Maechler. This is followed by a further comment in reply, from Colin Fay." style="margin-bottom:20px">
</center>
...
<center>
<img src="bug_report_patch.png" alt="Screenshot of a bug report with the attachments section circled in red." style="margin-bottom:20px">
</center>
...
<center>
<img src="bug_report_diff.png" alt="Screenshot of the diff for an attached patch displayed in the browser. On the left is the original source code from an R file. On the right is the proposed update to that code. The lines of code that have been modified are coloured to highlight where changes have been made." style="margin-bottom:20px">
</center>
...
<center>
<img src="bug-bbq_GitHub.png" alt="Screenshot of the r-devel/bug-bbq GitHub repository. The repository contains a few code files and a README.md" style="margin-bottom:20px">
</center>
...
<center>
<img src="issues.png" alt="Screenshot of the Issues page of the bug-bbq repo." style="margin-bottom:20px">
</center>
...
<img src="reshot-icon-rocket-ZQTKM9NG32.svg" alt="Cartoon of a rocket launching" style="width:20%; margin-bottom:10px;">
